...
function FilliereCardAdmin({nom}) {
  ...
  return (
    <div className='filliere-card-admin flex justify-center pr-6 mt-6'>
...
export default FilliereCardAdmin